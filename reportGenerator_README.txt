...
optional arguments:
  ...
  --templateName TEMPLATENAME  (Optional) Set the template name to integrate Threat Dragon model with provided template. Applicable only with reportType application_model_threat_dragon and application_model_threat_dragon_plus.
