    ...
    stages{
        ...
        stage('Access First URL') {
         ...
         stage('Generate Report'){
		    ...
		    sh 'python3 reportGenerator.py --fromdate "2024-03-28 00:00:01" --domain ACME --subdomain DEV2 --reportType application_model_threat_dragon_plus --templateName ACME-Template.mod'
                }
            }
        }
